  ...
  return (
    <div className={styles.services}>
      ...
      <section className={styles.banner}>
        <div className={styles.loremIpsumDolor}>HOME - SERVICES</div>
        <h1 className={styles.mediumLengthHero}>Services</h1>
      </section>
      <section className={styles.services1}>
        <div className={styles.heading}>
          <div className={styles.loremIpsumDolor1}>SERVICES</div>
          <h1 className={styles.mediumLengthHero1}>Facials</h1>
        </div>
        <Content2 />
      </section>
